...
if __name__ == '__main__':
    ...
    result_file_path_S600E = "./result-data2/S5700/"
    #
    # all_product_divID = {"section7.3.4.5.1", "section7.3.4.5.2", "section7.3.4.5.3", "section7.3.4.5.4",
    #                      "section7.3.4.5.5", "section7.3.4.5.6", "section7.3.4.5.7", "section7.3.4.5.8",
    #                      "section7.3.4.5.9", "section7.3.4.5.10", "section7.3.4.5.11", "section7.3.4.5.12",
    #                      "section7.3.4.5.13", "section7.3.4.5.14", "section7.3.4.5.15", "section7.3.4.5.16",
    #                      "section7.3.4.5.17", "section7.3.4.5.18", "section7.3.4.5.19", "section7.3.4.5.20",
    #                      "section7.3.4.5.21", "section7.3.4.5.22"}

    # all_product_divID = {"section7.3.4.6.1", "section7.3.4.6.2", "section7.3.4.6.3", "section7.3.4.6.4",
    #                      "section7.3.4.6.6", "section7.3.4.6.7", "section7.3.4.6.8", "section7.3.4.6.9",
    #                      "section7.3.4.6.10", "section7.3.4.6.11", "section7.3.4.6.12", "section7.3.4.6.13",
    #                      "section7.3.4.6.13"}
