...
$$(document).ready(function(){
	...
	var src = $$("script[src$='cncstm.js']").get(0).src+"/../icon-arrowrt.gif";
...
function doSearchRecommendShow(_self){
	...
	if(display==null || display=="none" || display==""){	
		$$("#"+idRelatedTopicsBody).show(600,function(){
				img.attr("src",img.attr("src").replace(/arrowrt.gif/i,"arrowdn.gif"));
		...
		$$("#"+idRelatedTopicsBody).hide(600,function(){
				img.attr("src",img.attr("src").replace(/arrowdn.gif/i,"arrowrt.gif"));
...
$$(document).ready(function(){
	...
	var src = $$("script[src$='2.files/2.js']").get(0).src+"http://127.0.0.1:7890/icon-arrowrt.gif";
	navTitleEle.innerHTML = '<img src="'+src+'" id="searchRecommendButton"></img><a href="javascript:void(0);" style="text-decoration:none">'+navTitle+'</a>';
	document.body.appendChild(navTitleEle);
	$$("#"+idRelatedTopicsTitle).addClass("srNavTitle");
	$$("#"+idRelatedTopicsBody).addClass("srNavBody");
...
function doSearchRecommendShow(_self){
	...
	if(display==null || display=="none" || display==""){	
		$$("#"+idRelatedTopicsBody).show(600,function(){
				img.attr("src",img.attr("src").replace(http://127.0.0.1:7890/arrowrt.gif/i,"http://127.0.0.1:7890/pages/AZI0304Q/02/AZI0304Q/02/resources/public_sys-resources/arrowdn.gif"));
				ele.attr("display","block");
			}
		);
		...
		$$("#"+idRelatedTopicsBody).hide(600,function(){
				img.attr("src",img.attr("src").replace(http://127.0.0.1:7890/arrowdn.gif/i,"http://127.0.0.1:7890/pages/AZI0304Q/02/AZI0304Q/02/resources/public_sys-resources/arrowrt.gif"));
				ele.attr("display","none");
			}
		);
	}
