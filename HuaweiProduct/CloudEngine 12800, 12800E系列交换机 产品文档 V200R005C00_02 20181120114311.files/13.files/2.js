...
function doSearchRecommendShow(_self){
	...
	if(display==null || display=="none" || display==""){	
		$$("#"+idRelatedTopicsBody).show(600,function(){
				img.attr("src",img.attr("src").replace(http://127.0.0.1:7890/arrowrt.gif/i,"http://127.0.0.1:7890/pages/31180AFB/02/31180AFB/02/resources/public_sys-resources/arrowdn.gif"));
				ele.attr("display","block");
			}
		);
		...
		$$("#"+idRelatedTopicsBody).hide(600,function(){
				img.attr("src",img.attr("src").replace(http://127.0.0.1:7890/arrowdn.gif/i,"http://127.0.0.1:7890/pages/31180AFB/02/31180AFB/02/resources/public_sys-resources/arrowrt.gif"));
				ele.attr("display","none");
			}
		);
	}
